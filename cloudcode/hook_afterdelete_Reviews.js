...
query.get(srcData.courseId, {
  success: function(course) {
    ...
    if (tgtData.reviewCount === 1) {
      ...
      var rateOverall = (tgtData.rateOverall * tgtData.reviewCount -
        srcData.rateOverall / 3) / (tgtData.reviewCount - 1);
    ...
    if (tgtData.birdCount === 1) {
      ...
      if (srcData.bird.value !== 0) {
        var birdOverall = (tgtData.birdOverall * tgtData.birdCount -
          srcData.bird.value) / (tgtData.birdCount - 1);
        course.increment("birdCount", -1);
    ...
    if (srcData.exam.touched) {
      ...
      if (tgtData.examCount === 1) {
        ...
        var examOverall = (tgtData.examOverall * tgtData.examCount -
          examValue) / (tgtData.examCount - 1);
        course.increment("examCount", -1);
